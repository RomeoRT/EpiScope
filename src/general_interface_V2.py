...
class InterfaceGenerale():
    def __init__(self, fenetre):
        ...
        self.bouton_reculer = ctk.CTkButton(self.frame_CTkButton, text="<<", command=self.lec_video.recule_progress,text_color='black',fg_color='sky blue')
        self.bouton_reculer.pack(side=ctk.LEFT, padx=30)

        self.bouton_pause_lecture = ctk.CTkButton(self.frame_CTkButton, text="Pause", command=self.lec_video.pause_lecture,text_color='black',fg_color='dodger blue')
        self.bouton_pause_lecture.pack(side=ctk.LEFT, padx=30)

        self.bouton_avancer = ctk.CTkButton(self.frame_CTkButton, text=">>", command=self.lec_video.avance_progress,text_color='black',fg_color='sky blue')
        self.bouton_avancer.pack(side=ctk.LEFT, padx=30)
        ...
        self.bouton_save = ctk.CTkButton(self.frame_right, text="générer texte", command=self.sauvegarde, text_color='black', fg_color='Plum3')
