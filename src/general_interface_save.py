"""
interface générale avec la liste des symptomes
    -> ajout de save avec un bouton (primitif)
...
from frise.fonctions_frise import chevauchement
from frise.fonctions_frise import afficher_frise
from frise.fonctions_frise import chercherElt
...
class InterfaceGenerale():
    def __init__(self, fenetre):
        """
        constructeur de l'interface generale

        place les boutons, divise l'interface, crée le lecteur video...
        """
        ...
        self.bouton_save = ctk.CTkButton(self.frame_right, text="save", command=self.sauvegarde, text_color='black', fg_color='Plum3')
