...
class InterfaceGenerale():
    def __init__(self, fenetre):
        ...
        self.frame_menu = ctk.CTkFrame(fenetre, corner_radius=0, fg_color='gray97',border_width=0, height=40)
        ...
        self.menu.config(bg='gray95',fg='black',font=police_label_m)
        self.menu["menu"].config(bg='whitesmoke', fg='black',font=14)
        ...
        self.bouton_revoir = ctk.CTkButton(self.frame_CTkButton, text="Revoir", command=self.lec_video.revoir_video, text_color='black', fg_color='navajo white')
        self.bouton_revoir.pack(side=ctk.LEFT, padx=40)

        self.bouton_reculer = ctk.CTkButton(self.frame_CTkButton, text="<<", command=self.lec_video.recule_progress,text_color='black',fg_color='gray80')
        self.bouton_reculer.pack(side=ctk.LEFT, padx=5)
        ...
        self.bouton_play_pause.pack(side=ctk.LEFT, padx=5)

        self.bouton_avancer = ctk.CTkButton(self.frame_CTkButton, text=">>", command=self.lec_video.avance_progress,text_color='black',fg_color='gray80')
        self.bouton_avancer.pack(side=ctk.LEFT, padx=5)

        self.bouton_nul = ctk.CTkButton(self.frame_CTkButton, text="", fg_color='gray97', hover_color='gray97')
        self.bouton_nul.pack(side=ctk.LEFT, padx=40)
        ...
        self.canvas = ctk.CTkCanvas(self.frame_middle, bg='white')
